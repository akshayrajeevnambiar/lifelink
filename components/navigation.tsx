    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          >
            <div
              className="p-2 rounded-xl bg-gradient-to-br from-red-500 to-red-600 shadow-lg shadow-red-500/20 group-hover:shadow-red-500/40 transition-shadow"
              aria-hidden="true"
            >
          ...
          {/* Navigation Links */}
          <div className="flex items-center space-x-2" role="navigation">
            <Button
            ...
            >
              <Link href="/search" className="flex items-center space-x-2">
                ...
                <span className="sr-only sm:hidden">Search for donors</span>
              </Link>
            </Button>
            ...
            <Button
              ...
              asChild
              className="rounded-xl"
              aria-current={pathname === "/donors/new" ? "page" : undefined}
            >
